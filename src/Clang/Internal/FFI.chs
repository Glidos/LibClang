...
enum TypeKind
  ...
  , Type_Auto = CXType_Auto
  , Type_Elaborated = CXType_Elaborated
  , Type_Pipe = CXType_Pipe
  , Type_OCLImage1dRO = CXType_OCLImage1dRO
  , Type_OCLImage1dArrayRO = CXType_OCLImage1dArrayRO
  , Type_OCLImage1dBufferRO = CXType_OCLImage1dBufferRO
  , Type_OCLImage2dRO = CXType_OCLImage2dRO
  , Type_OCLImage2dArrayRO = CXType_OCLImage2dArrayRO
  , Type_OCLImage2dDepthRO = CXType_OCLImage2dDepthRO
  , Type_OCLImage2dArrayDepthRO = CXType_OCLImage2dArrayDepthRO
  , Type_OCLImage2dMSAARO = CXType_OCLImage2dMSAARO
  , Type_OCLImage2dArrayMSAARO = CXType_OCLImage2dArrayMSAARO
  , Type_OCLImage2dMSAADepthRO = CXType_OCLImage2dMSAADepthRO
  , Type_OCLImage2dArrayMSAADepthRO = CXType_OCLImage2dArrayMSAADepthRO
  , Type_OCLImage3dRO = CXType_OCLImage3dRO
  , Type_OCLImage1dWO = CXType_OCLImage1dWO
  , Type_OCLImage1dArrayWO = CXType_OCLImage1dArrayWO
  , Type_OCLImage1dBufferWO = CXType_OCLImage1dBufferWO
  , Type_OCLImage2dWO = CXType_OCLImage2dWO
  , Type_OCLImage2dArrayWO = CXType_OCLImage2dArrayWO
  , Type_OCLImage2dDepthWO = CXType_OCLImage2dDepthWO
  , Type_OCLImage2dArrayDepthWO = CXType_OCLImage2dArrayDepthWO
  , Type_OCLImage2dMSAAWO = CXType_OCLImage2dMSAAWO
  , Type_OCLImage2dArrayMSAAWO = CXType_OCLImage2dArrayMSAAWO
  , Type_OCLImage2dMSAADepthWO = CXType_OCLImage2dMSAADepthWO
  , Type_OCLImage2dArrayMSAADepthWO = CXType_OCLImage2dArrayMSAADepthWO
  , Type_OCLImage3dWO = CXType_OCLImage3dWO
  , Type_OCLImage1dRW = CXType_OCLImage1dRW
  , Type_OCLImage1dArrayRW = CXType_OCLImage1dArrayRW
  , Type_OCLImage1dBufferRW = CXType_OCLImage1dBufferRW
  , Type_OCLImage2dRW = CXType_OCLImage2dRW
  , Type_OCLImage2dArrayRW = CXType_OCLImage2dArrayRW
  , Type_OCLImage2dDepthRW = CXType_OCLImage2dDepthRW
  , Type_OCLImage2dArrayDepthRW = CXType_OCLImage2dArrayDepthRW
  , Type_OCLImage2dMSAARW = CXType_OCLImage2dMSAARW
  , Type_OCLImage2dArrayMSAARW = CXType_OCLImage2dArrayMSAARW
  , Type_OCLImage2dMSAADepthRW = CXType_OCLImage2dMSAADepthRW
  , Type_OCLImage2dArrayMSAADepthRW = CXType_OCLImage2dArrayMSAADepthRW
  , Type_OCLImage3dRW = CXType_OCLImage3dRW
  , Type_OCLSampler = CXType_OCLSampler
  , Type_OCLEvent = CXType_OCLEvent
  , Type_OCLQueue = CXType_OCLQueue
  , Type_OCLReserveID = CXType_OCLReserveID
  , Type_ObjCObject = CXType_ObjCObject
  , Type_ObjCTypeParam = CXType_ObjCTypeParam
  , Type_Attributed = CXType_Attributed
  , Type_OCLIntelSubgroupAVCMcePayload = CXType_OCLIntelSubgroupAVCMcePayload
  , Type_OCLIntelSubgroupAVCImePayload = CXType_OCLIntelSubgroupAVCImePayload
  , Type_OCLIntelSubgroupAVCRefPayload = CXType_OCLIntelSubgroupAVCRefPayload
  , Type_OCLIntelSubgroupAVCSicPayload = CXType_OCLIntelSubgroupAVCSicPayload
  , Type_OCLIntelSubgroupAVCMceResult = CXType_OCLIntelSubgroupAVCMceResult
  , Type_OCLIntelSubgroupAVCImeResult = CXType_OCLIntelSubgroupAVCImeResult
  , Type_OCLIntelSubgroupAVCRefResult = CXType_OCLIntelSubgroupAVCRefResult
  , Type_OCLIntelSubgroupAVCSicResult = CXType_OCLIntelSubgroupAVCSicResult
  , Type_OCLIntelSubgroupAVCImeResultSingleReferenceStreamout = CXType_OCLIntelSubgroupAVCImeResultSingleReferenceStreamout
  , Type_OCLIntelSubgroupAVCImeResultDualReferenceStreamout = CXType_OCLIntelSubgroupAVCImeResultDualReferenceStreamout
  , Type_OCLIntelSubgroupAVCImeSingleReferenceStreamin = CXType_OCLIntelSubgroupAVCImeSingleReferenceStreamin
  , Type_OCLIntelSubgroupAVCImeDualReferenceStreamin = CXType_OCLIntelSubgroupAVCImeDualReferenceStreamin
  , Type_OCLIntelSubgroupAVCImeResultSingleRefStreamout = CXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout
  , Type_OCLIntelSubgroupAVCImeResultDualRefStreamout = CXType_OCLIntelSubgroupAVCImeResultDualRefStreamout
  , Type_OCLIntelSubgroupAVCImeSingleRefStreamin = CXType_OCLIntelSubgroupAVCImeSingleRefStreamin
  , Type_OCLIntelSubgroupAVCImeDualRefStreamin = CXType_OCLIntelSubgroupAVCImeDualRefStreamin
  , Type_ExtVector = CXType_ExtVector
  , Type_Atomic = CXType_Atomic
  , Type_BTFTagAttributed = CXType_BTFTagAttributed
 };
#endc
